...
class activity_usoWord : AppCompatActivity() {

    /**
     * Declaramos las variables a utilizar.
     */
    private lateinit var binding: ActivityUsoWordBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityUsoWordBinding.inflate(layoutInflater)
        setContentView(binding.root)

        /**
         * Definimos la ruta de ubicación de los vídeos.
         */
        inicio = findViewById(R.id.video6_wo_inicio)
         ...
         */
        binding.imgbtnWoHome.setOnClickListener {
