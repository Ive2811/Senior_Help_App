...
class activity_computadora : AppCompatActivity() {

    /**
     * Declaramos las variables a utilizar.
     */
    private lateinit var binding: ActivityComputadoraBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityComputadoraBinding.inflate(layoutInflater)
        setContentView(binding.root)

        /**
         * Definimos la ruta de ubicación de los vídeos.
         */
        inicio = findViewById(R.id.video5_com_inicio)
         ...
         */
        binding.imgbtnComHome.setOnClickListener {
